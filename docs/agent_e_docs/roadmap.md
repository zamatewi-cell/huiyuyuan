...
- [x] Resolve legacy encoding debt in `huiyuyuan_app/backend/scripts/ssl_setup.sh`.
...
- `huiyuyuan_app/backend/scripts/ssl_setup.sh` encoding cleanup is being handled by an external collaborating agent.
