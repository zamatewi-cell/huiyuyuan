...
<p align="center">
  <strong>🌟 Liquid Glass 设计风格 | OpenRouter 多模态 AI 驱动 | 跨平台支持</strong>
</p>
...
**汇玉源**是一款面向珠宝行业的智能交易平台，集成了 OpenRouter 免费多模态模型，为珠宝商家提供智能化的销售、客服和看图识别体验。

### 核心功能
| 功能 | 描述 | 状态 |
|------|------|------|
| 🛒 **智能商城** | 浏览和购买精选珠宝产品 | ✅ 完成 |
| 🤖 **AI 助手** | 基于 DashScope / 千问模型的智能客服"玉小助" | ✅ 完成 |
...
### OpenRouter 集成
应用集成了 OpenRouter 免费多模态模型，统一提供智能对话和图片识别能力：
...
class AppConfig {
  static const String openRouterApiKey = 'sk-or-v1-xxx...';  // OpenRouter API Key
...
### v3.0.3 (2026-03-18)
**支付账户 API 收口**
- ✨ 收款账户页改为 `/api/users/payment-accounts` API 驱动
- 🧹 清理旧的本地支付账户存储逻辑与重复模型
- ✅ 补充 payment account / provider / screen 回归测试
- 🧪 在本机使用 `.\scripts\run_flutter_test_no_proxy.ps1` 规避代理环境对 Flutter 测试的干扰
