...
import 'package:huiyuanyuan/config/local_debug_config.dart';
import 'package:huiyuanyuan/services/ai_dashscope_service.dart';
...
void main() {
  ...
  test('reports invalid local debug config before calling DashScope', () async {
    LocalDebugConfig.instance.replaceValuesForTesting(
      const {},
      loadedFromPath: 'huiyuanyuan_app/.env.json',
    ...
    expect(service.lastError, contains('huiyuanyuan_app/.env.json'));
  });
