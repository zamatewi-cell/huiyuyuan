...
echo "  2. On-server backend deploy: bash /srv/huiyuanyuan/backend/deploy_current_server.sh" >&2
echo "  3. On-server SSL setup:     bash /srv/huiyuanyuan/backend/scripts/ssl_setup.sh xn--lsws2cdzg.top" >&2
echo "" >&2
