...
class _ProductListScreenState extends ConsumerState<ProductListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedCategory =
        categories.contains(_selectedCategory) ? _selectedCategory : '鍏ㄩ儴';
        ...
        slivers: [
          ...
          SliverPersistentHeader(
            ...
            delegate: _StickyCategoryDelegate(
              ...
              translate: (key) => _translateCategory(key, ref),
              context: context,
            ),
          ),
          SliverPadding(
                ...
                : products.isEmpty
                    ? SliverToBoxAdapter(
                        child: _buildEmptyState(
                          message:
                              productCatalogState.errorMessage ?? '鏆傛棤鍟嗗搧鏁版嵁',
                        ),
                      )
                    : SliverGrid(
                        gridDelegate:
  ...
  String _translateCategory(String key, WidgetRef ref) {
    switch (key) {
      case '鍏ㄩ儴':
    ...
    return Container(
      ...
      child: Center(
        child: Icon(
          Icons.diamond,
          size: 60,
          color: JewelryColors.getMaterialColor(material),
        ),
      ),
    );
  }
