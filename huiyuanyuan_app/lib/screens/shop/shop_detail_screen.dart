...
class _ShopDetailScreenState extends ConsumerState<ShopDetailScreen>
  ...
  Future<void> _loadContacts() async {
    final records =
        await _contactService.getShopContacts(widget.shop.id);
    if (mounted) {
      setState(() {
      ...
      child: Column(
        children: [
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            widget.shop.contactStatus.label,
                            style: TextStyle(
                              color: widget.shop.contactStatus.color,
                              fontSize: 11,
                            ),
          ...
          Row(
            ...
            children: [
              _buildStatItem('月销量', '${(widget.shop.rating * 1000).toInt()}+'),
              _buildDivider(),
              _buildStatItem('粉丝数', '5.2万'),
              _buildDivider(),
              _buildStatItem('转化率', '5.3%'),
            ],
          ),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoSection('基本信息', [
            _buildInfoRow(Icons.category, '主营类目', widget.shop.category),
            _buildInfoRow(Icons.shopping_bag, '平台', widget.shop.platform),
            _buildInfoRow(
                Icons.star, '店铺评分', widget.shop.rating.toStringAsFixed(1)),
            _buildInfoRow(Icons.phone, '联系电话', '暂无'),
          ]),
        ],
      ),
    );
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isGenerating
                        ...
                        : Text(_generatedDialogue == null ? '生成话术' : '重新生成'),
                  ),
                ),
              ],
            ),
