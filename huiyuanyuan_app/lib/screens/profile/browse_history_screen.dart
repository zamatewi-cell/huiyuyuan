...
class _HistoryCard extends StatelessWidget {
  ...
  Map<String, dynamic> _findProduct() {
    final match = realProductData.where((p) => p.id == productId);
    if (match.isNotEmpty) {
      final p = match.first;
      return {
        'name': p.name,
    ...
    return {'name': '商品 $productId', 'price': 0.0, 'material': '', 'image': null};
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if ((product['material'] as String).isNotEmpty)
                  Text(
