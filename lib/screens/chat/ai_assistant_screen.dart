...
class _AIAssistantScreenState extends ConsumerState<AIAssistantScreen>
  ...
  Widget _buildMessageBubble(ChatMessage message, bool isDark) {
    ...
    final cleanContent = message.content.replaceAll(RegExp(r'\[PRODUCT:[^\]]+\]\s*'), '').trim();
                  ...
                  children: [
                        ...
                        : GlassmorphicCard(
                            ...
                            child: MarkdownBody(
                              ...
                              styleSheet: MarkdownStyleSheet(
                                ...
                                h1: TextStyle(color: isDark ? Colors.white : Colors.black87, fontSize: 20),
                                h2: TextStyle(color: isDark ? Colors.white : Colors.black87, fontSize: 18),
                                h3: TextStyle(color: isDark ? Colors.white : Colors.black87, fontSize: 16),
                                code: TextStyle(
                    ...
                    if (!isUser && productIds.isNotEmpty)
                      Padding(
                        ...
                        child: Column(
                          children: productIds.map((id) => _buildProductCard(id, isDark)).toList(),
                        ),
                      ),
            ...
            ClipRRect(
              ...
              child: Image.network(
                ...
                errorBuilder: (_, __, ___) => Container(
                  ...
                  height: 100,
                  color: JewelryColors.primary.withOpacity(0.1),
                  child: const Icon(Icons.diamond, color: JewelryColors.primary, size: 40),
                ),
              ),
            ),
            // 商品信息
