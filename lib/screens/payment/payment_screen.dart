  ...
  Future<void> _startPayment() async {
    ...
    try {
      ...
      try {
        ...
        await dio.post(
          'http://47.98.188.141/api/orders/${widget.order.id}/pay',
          data: {'method': _selectedMethod},
          options: Options(headers: {'Authorization': 'Bearer mock_token'}),
        );
      } catch (_) {
        // \u540E\u7AEF\u4E0D\u53EF\u7528\u65F6\u5F00\u542F\u672C\u5730\u6A21\u62DF
      }
      ...
      _pollTimer = Timer.periodic(const Duration(seconds: 1), (timer) async {
        ...
        try {
          ...
          final resp = await dio.get(
            'http://47.98.188.141/api/orders/${widget.order.id}/pay-status',
            options: Options(headers: {'Authorization': 'Bearer mock_token'}),
          );
        ...
        // \u672C\u5730\u6A21\u62DF: 3\u79D2\u540E\u81EA\u52A8\u6210\u529F
        if (pollCount >= 3 && _payState == 'processing') {
          timer.cancel();
          _onPaymentSuccess();
        }
      });
