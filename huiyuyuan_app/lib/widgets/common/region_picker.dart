...
class _RegionPickerState extends ConsumerState<RegionPicker>
  ...
  Widget build(BuildContext context) {
    ...
    final hintColor =
        isDark ? const Color(0xFF8888AA) : const Color(0xFF6B7280);
          ...
          Container(
            ...
            child: Row(
              children: [
                _buildTabItem(
                  0,
                  _selectedProvince ?? ref.tr('region_picker_placeholder'),
                ...
                if (_selectedProvince != null)
                  _buildTabItem(
                    1,
                    _selectedCity ?? ref.tr('region_picker_placeholder'),
                    _selectedCity != null,
                    textColor,
                    hintColor,
                  ),
                if (_selectedCity != null && _districts.isNotEmpty)
                  _buildTabItem(
                    2,
                    _selectedDistrict ?? ref.tr('region_picker_placeholder'),
                    _selectedDistrict != null,
                    textColor,
                    hintColor,
                  ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(
              color: isActive ? JewelryColors.primaryGreen : Colors.transparent,
              width: 2,
            ),
          ),
        ),
  ...
  Widget _buildList(
    ...
    if (items.isEmpty) {
      return Center(
        child: Text(
          ref.tr('region_picker_select_parent'),
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 15,
                      color:
                          isSelected ? JewelryColors.primaryGreen : textColor,
                      fontWeight:
