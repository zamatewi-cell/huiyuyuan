...
#
# Usage:
#   sudo bash /opt/huiyuyuan/scripts/security_harden.sh [--check-only]
# ============================================================
...
SYSCTL_CONF="/etc/sysctl.d/99-huiyuyuan-security.conf"
...
check "test -f /etc/logrotate.d/huiyuyuan" "Logrotate configured for app"
